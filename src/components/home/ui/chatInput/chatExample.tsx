            ...
            <div className="group relative">
                <div className="flex gap-2 justify-center py-2 flex-wrap">
                    {displayedPrompts.map((prompt, index) => (
                        ...
                        >
                            <div
                                className={`w-fit h-fit px-3 py-2 select-none cursor-pointer rounded-full border-[${CssVariableNames.borderColor}]
                                    bg-[${CssVariableNames.foregroundColor}] text-sm font-normal text-[${CssVariableNames.backgroundColor}]
                                    hover:text-[${CssVariableNames.foregroundHoverColor}] transition-colors`}
                ...
                <div
                    ...
                    className={`flex justify-center items-center h-5 w-5 p-0 rounded-full opacity-0 group-hover:opacity-100
                        transition-opacity duration-200 hover:bg-[${CssVariableNames.buttonHoverColor}]`}
                >
                    <motion.div
                        animate={{rotate: isRefreshing ? 360 : 0}}
                        transition={{duration: 0.3, ease: "easeInOut"}}
                    >
                        <RefreshCw size={10} className={`text-[${CssVariableNames.foregroundColor}]`}/>
                    </motion.div>
                </div>
            </div>
        </div>
